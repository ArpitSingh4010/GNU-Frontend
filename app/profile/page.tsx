...
export default function ProfilePage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // Mock user data - in real app, this would come from API based on logged-in user
      const mockUserData: UserData = {
        userId: "759943",
        name: "Arpit Singh",
        email: localStorage.getItem('userEmail') || "arpit.singh@srmist.edu.in",
        score: 212,
        totalScore: 1200,
    ...
    <>
      ...
      <div style={styles.profileContainer}>
        <div style={responsiveStyles.container}>
          ...
          {/* Profile Header */}
          <header style={responsiveStyles.profileHeader} className="animate-in">
